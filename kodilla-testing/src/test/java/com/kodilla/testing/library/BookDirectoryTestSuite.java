...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksWithConditionsMoreThan20(){
        ...
        assertEquals(15, theListOfBook15);
        assertEquals(0, theListOfBooks40);


        assertTrue(false); //powinno zwrocic pusta liste
    }

    @Test
    public void testListBooksWIthConditionFragmentShorterThan3(){
        assertTrue(false); //spr czy zwracana lista ksiazek jest pusta w sytuacji gdy gramgent tytulu krotszy niz 3 znaki
    }
